...
VALUES
    (
        'my-khe-strip',
        'Dải biển Mỹ Khê',
        'Vùng bãi biển Mỹ Khê dùng để tính khoảng cách từ địa điểm tới khu biển.',
    ...
    (
        'an-thuong-zone',
        'Khu An Thượng',
        'Vùng phố An Thượng gần khu biển Mỹ An.',
    ...
    (
        'son-tra-south',
        'Khu Sơn Trà',
        'Vùng Sơn Trà dùng để tính khoảng cách theo khu vực.',
...
VALUES
    ('dragon-bridge', 'Cầu Rồng', 'point', 16.0611682, 108.2278968, '{"source":"osm:nominatim","osm_type":"way","osm_id":694831926,"area":"Phường An Hải","placeholder":false}'::jsonb),
    ('han-bridge', 'Cầu Sông Hàn', 'point', 16.0721398, 108.2268106, '{"source":"osm:nominatim","osm_type":"node","osm_id":7276380289,"area":"Phường An Hải","placeholder":false}'::jsonb),
    ('han-market', 'Chợ Hàn', 'point', 16.0683555, 108.2244297, '{"source":"osm:nominatim","osm_type":"way","osm_id":204885903,"area":"Phường Hải Châu","placeholder":false}'::jsonb),
    ('da-nang-airport', 'Sân bay Đà Nẵng', 'point', 16.0425792, 108.1971613, '{"source":"osm:nominatim","osm_type":"way","osm_id":217476265,"iata":"DAD","placeholder":false}'::jsonb),
    ('marble-mountains', 'Ngũ Hành Sơn', 'point', 16.0040200, 108.2627745, '{"source":"osm:nominatim","osm_type":"relation","osm_id":8552348,"area":"Phường Ngũ Hành Sơn","placeholder":false}'::jsonb),
    ('my-khe-beach', 'Bãi biển Mỹ Khê', 'zone_ref', 16.0756383, 108.2468740, '{"source":"osm:nominatim+overpass","osm_type":"relation","osm_id":19000664,"zone_slug":"my-khe-strip","placeholder":false}'::jsonb),
    ('an-thuong', 'An Thượng', 'zone_ref', 16.0498000, 108.2413000, '{"source":"osm:derived","zone_slug":"an-thuong-zone","placeholder":false,"note":"Derived from named An Thuong street grid in OSM"}'::jsonb),
    ('son-tra-peninsula', 'Bán đảo Sơn Trà', 'zone_ref', 16.1021731, 108.2485821, '{"source":"osm:nominatim+overpass","osm_type":"relation","osm_id":13996982,"zone_slug":"son-tra-south","placeholder":false}'::jsonb)
ON CONFLICT (slug) DO UPDATE SET
    name = EXCLUDED.name,
    kind = EXCLUDED.kind,
    lat = EXCLUDED.lat,
